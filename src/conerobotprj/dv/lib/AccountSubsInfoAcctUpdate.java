 ...
 *
 */
public class AccountSubsInfoAcctUpdate {
	...
	public static void createSEAccountInfoUpdate(SOAPMessage soapMessage, String MSISDN, String Fname, String Lname,
			String address, String City, String ContactPhone, String id, String Company, String genderV, String DoB,
			String IDType) throws SOAPException {
		...
		aiaig.callingAccountInfoRetrieve(src.parentAccountInternalId);
		// LOGGER.log(Level.INFO, "ExtendedData : " + aiaig.extendedData);
		ed = aiaig.extendedData;
		start = ed.indexOf("<Parameter name=\"Customer_DOB\">");
		end = ed.indexOf("</Parameter>", start);

		DOBOrig = ed.substring(start, end + 12);
		DOBReplaced = "<Parameter name=\"Customer_DOB\"><DateValue>" + DoB + "T00:00:00.0</DateValue></Parameter>";
		...
		if (start == -1) {
			...
			start = ed.indexOf("<Parameter xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" name=\"id_type\" xsi:nil=\"true\">");
			end = ed.indexOf("</Parameter>", start);
			IDTYPEOrig = ed.substring(start, end + 12);
			IDTYPEReplaced = "<Parameter xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" name=\"id_type\" xsi:nil=\"true\"><StringValue>" + IDType + "</StringValue></Parameter>";
		...
		SOAPElement gender = account.addChildElement("gender");
		gender.addAttribute(setQname, "true");
		gender.addAttribute(changedQname, "true");
		SOAPElement genderValue = gender.addChildElement("value");
		genderValue.addTextNode(genderV);
		...
		extendedDataValue.addTextNode(EDUpdated);
	...
	private static SOAPMessage createSOAPRequest(String soapAction, String MSISDN, String Fname, String Lname,
		...
		createSEAccountInfoUpdate(soapMessage, MSISDN, Fname, Lname, address, City, ContactPhone, id, Company, genderV,
				DoB, IDType);
	...
	public static void callingAccountInfoUpdate(String MSISDN, String Fname, String Lname, String address, String City,
			String ContactPhone, String id, String Company, String genderV, String DoB, String IDType) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(soapAction, MSISDN, Fname, Lname, address,
					City, ContactPhone, id, Company, genderV, DoB, IDType), soapEndpointUrl);
