...
public class NCAMobile {
	...
	public static void createSENCAMobile(SOAPMessage soapMessage, String ModeFlag, String PrimaryOfferId,
			...
			String city, String state, String country, String MSISDN, String ICCID, String IMSI) throws SOAPException {
//ModeFlag: 1 Prepaid else Postpaid 
		...
		extendedDataSubValue.addTextNode(
				"<![CDATA[<ExtendedData><Parameter name=\"Nationality\"><IntegerValue>72</IntegerValue></Parameter><Parameter name=\"Customer Profession\"><StringValue>Government</StringValue></Parameter><Parameter name=\"notif_number\"><StringValue>"
						+ MSISDN + "</StringValue></Parameter></ExtendedData>]]>");
		...
		// MSISDN
		SOAPElement subscriberExternalIdListMSISDN = input.addChildElement("subscriberExternalIdList");
		SOAPElement serviceExternalIdMSISDN = subscriberExternalIdListMSISDN.addChildElement("serviceExternalId");
		serviceExternalIdMSISDN.addAttribute(setQname, "true");
		serviceExternalIdMSISDN.addAttribute(changedQname, "true");
		SOAPElement serviceExternalIdMSISDNValue = serviceExternalIdMSISDN.addChildElement("value");
		serviceExternalIdMSISDNValue.addTextNode(MSISDN);
		SOAPElement serviceExternalIdTypeMSISDN = subscriberExternalIdListMSISDN
				.addChildElement("serviceExternalIdType");
		serviceExternalIdTypeMSISDN.addAttribute(setQname, "true");
		serviceExternalIdTypeMSISDN.addAttribute(changedQname, "true");
		SOAPElement serviceExternalIdTypeMSISDNValue = serviceExternalIdTypeMSISDN.addChildElement("value");
		serviceExternalIdTypeMSISDNValue.addTextNode("1");

		// ICCID
		SOAPElement subscriberExternalIdListICCID = input.addChildElement("subscriberExternalIdList");
		SOAPElement serviceExternalIdICCID = subscriberExternalIdListICCID.addChildElement("serviceExternalId");
		serviceExternalIdICCID.addAttribute(setQname, "true");
		serviceExternalIdICCID.addAttribute(changedQname, "true");
		SOAPElement serviceExternalIdICCIDValue = serviceExternalIdICCID.addChildElement("value");
		serviceExternalIdICCIDValue.addTextNode(ICCID);
		SOAPElement serviceExternalIdTypeICCID = subscriberExternalIdListICCID.addChildElement("serviceExternalIdType");
		serviceExternalIdTypeICCID.addAttribute(setQname, "true");
		serviceExternalIdTypeICCID.addAttribute(changedQname, "true");
		SOAPElement serviceExternalIdTypeICCIDValue = serviceExternalIdTypeICCID.addChildElement("value");
		serviceExternalIdTypeICCIDValue.addTextNode("107");

		// IMSI
		SOAPElement subscriberExternalIdListIMSI = input.addChildElement("subscriberExternalIdList");
		SOAPElement serviceExternalIdIMSI = subscriberExternalIdListIMSI.addChildElement("serviceExternalId");
		serviceExternalIdIMSI.addAttribute(setQname, "true");
		serviceExternalIdIMSI.addAttribute(changedQname, "true");
		SOAPElement serviceExternalIdIMSIValue = serviceExternalIdIMSI.addChildElement("value");
		serviceExternalIdIMSIValue.addTextNode(IMSI);
		SOAPElement serviceExternalIdTypeIMSI = subscriberExternalIdListIMSI.addChildElement("serviceExternalIdType");
		serviceExternalIdTypeIMSI.addAttribute(setQname, "true");
		serviceExternalIdTypeIMSI.addAttribute(changedQname, "true");
		SOAPElement serviceExternalIdTypeIMSIValue = serviceExternalIdTypeIMSI.addChildElement("value");
		serviceExternalIdTypeIMSIValue.addTextNode("2");
	...
	// Create SOAP request
	public static SOAPMessage createSRNCAMobile(String soapAction, String ModeFlag, String PrimaryOfferId,
			String ParentAccount, String Fname, String Lname, String CompanyName, String ID, String IDType,
			String IDExpiry, String NotifNumber, String Address1, String Address2, String Address3, String Address4,
			String city, String state, String country, String MSISDN, String ICCID, String IMSI) throws Exception {

		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();

		createSENCAMobile(soapMessage, ModeFlag, PrimaryOfferId, ParentAccount, Fname, Lname, CompanyName, ID, IDType,
				IDExpiry, NotifNumber, Address1, Address2, Address3, Address4, city, state, country, MSISDN, ICCID,
				IMSI);
	...
	public void callNCAMobile(String ModeFlag, String PrimaryOfferId, String ParentAccount, String Fname, String Lname,
			String CompanyName, String ID, String IDType, String IDExpiry, String NotifNumber, String Address1,
			String Address2, String Address3, String Address4, String city, String state, String country, String MSISDN,
			String ICCID, String IMSI) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(createSRNCAMobile(soapAction, ModeFlag, PrimaryOfferId,
					ParentAccount, Fname, Lname, CompanyName, ID, IDType, IDExpiry, NotifNumber, Address1, Address2,
					Address3, Address4, city, state, country, MSISDN, ICCID, IMSI), soapEndpointUrl);
			...
			soapResponse.writeTo(new FileOutputStream(new File("src/input/NCAMobile.xml")));
			soapConnection.close();

			File xmlresponse = new File("src/input/NCAMobile.xml");
			...
			if (childnodes.item(0).getNodeName().equals("S:Body")) {
				...
				LOGGER.log(Level.INFO, "RESULT SUCCESS: " + MSISDN);
			}
