 ...
 *
 */
public class SimRegistrationDOBOnly {
	...
	public static void createSEAccountInfoUpdate(SOAPMessage soapMessage, String MSISDN, String DoB) throws SOAPException {
	...
	private static SOAPMessage createSOAPRequest(String soapAction, String MSISDN, String DoB) throws Exception {

		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();

		createSEAccountInfoUpdate(soapMessage, MSISDN, DoB);
	...
	public static void callingSubInfoUpdate(String MSISDN, String DoB) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(
					createSOAPRequest(soapAction, MSISDN,  DoB),
					soapEndpointUrl);
			...
			soapResponse.writeTo(new FileOutputStream(new File("src/input/SimRegUpdateDOB.xml")));
			soapConnection.close();

			// Read Subscriber retrieve response from temp xml file
			LOGGER.log(Level.INFO, "Simplified Results --> " + MSISDN);

			File xmlresponse = new File("src/input/SimRegUpdateDOB.xml");
