 ...
 *
 */
public class SubscriberInfoUpdate {
	...
	public static void createSEAccountInfoUpdate(SOAPMessage soapMessage, String MSISDN, String Fname, String Lname,
			String ContactPhone, String DoB) throws SOAPException {
	...
	private static SOAPMessage createSOAPRequest(String soapAction, String MSISDN, String Fname, String Lname,
			String ContactPhone, String DoB) throws Exception {

		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();

		createSEAccountInfoUpdate(soapMessage, MSISDN, Fname, Lname, ContactPhone, DoB);
	...
	public static void callingSubInfoUpdate(String MSISDN, String Fname, String Lname, String ContactPhone,
			String DoB) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection
					.call(createSOAPRequest(soapAction, MSISDN, Fname, Lname, ContactPhone, DoB), soapEndpointUrl);
			...
			soapResponse.writeTo(new FileOutputStream(new File("src/input/SubsInfoUpdate.xml")));
			soapConnection.close();

			// Read Subscriber retrieve response from temp xml file
			LOGGER.log(Level.INFO, "Simplified Results --> " + MSISDN);

			File xmlresponse = new File("src/input/SubsInfoUpdate.xml");
			...
			if (childnodes.item(0).getNodeName().equals("S:Body")) {
					...
					if (child.getNodeType() == Node.ELEMENT_NODE) {
						if (childnodes.item(i).getTextContent().trim() != "") {
							...
							LOGGER.log(Level.SEVERE,
									"RESULT::FAIL SUB INFO UPDATE : " + "::" + childnodes.item(i).getNodeName() + "::"
				...
				LOGGER.log(Level.INFO, "RESULT::SUCCESS SUB INFO UPDATE::" + tempSubInfo);
