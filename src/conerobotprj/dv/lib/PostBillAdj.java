...
public class PostBillAdj {
	...
	public static void createSEPostbillAdjustment(SOAPMessage soapMessage, String AccountNo, String vadjReasonCode,
			String vamount, String vannotation, String vorigBillRefNo, String vorigBillRefResets) throws SOAPException {
	...
	public static SOAPMessage createSRPostBillAdj(String soapAction, String AccountNo, String vadjReasonCode,
			String vamount, String vannotation, String vorigBillRefNo, String vorigBillRefResets) throws Exception {
	...
	public void callPostBillAdj(String AccountNo, String vadjReasonCode, String vamount, String vannotation,
			String vorigBillRefNo, String vorigBillRefResets) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(createSRPostBillAdj(soapAction, AccountNo, vadjReasonCode,
					vamount, vannotation, vorigBillRefNo, vorigBillRefResets), soapEndpointUrl);
			...
			LOGGER.log(Level.INFO, "<-- End Processing MSISDN " + AccountNo + " ; Bill_ref_no: " + vorigBillRefNo);
			LOGGER.log(Level.INFO, "--------------------------------------");
		} catch (Exception e) {
