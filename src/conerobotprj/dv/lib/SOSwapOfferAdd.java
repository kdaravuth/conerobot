...
public class SOSwapOfferAdd {
	...
	public static void createSESOSwapOfferAdd(SOAPMessage soapMessage, String subscrNo, String subscrNoReset, String swappedInOffer)
		...
		offerIdValue.addTextNode(swappedInOffer);
	...
	// Create SOAP request
	private static SOAPMessage createSRSOSwapOfferAdd(String soapAction, String subscrNo, String subscrNoReset, String swappedInOffer)
			throws Exception {
		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();

		createSESOSwapOfferAdd(soapMessage, subscrNo, subscrNoReset, swappedInOffer);
	...
	public static void callingSOSwapOfferAdd(String subscrNo, String subscrNoReset, String swappedInOffer)
		...
		try {
			...
			LOGGER.log(Level.FINEST, "Adding Offer....");
			SOAPMessage soapResponse = soapConnection.call(createSRSOSwapOfferAdd(soapAction, subscrNo, subscrNoReset, swappedInOffer),
					soapEndpointUrl);
			...
			soapResponse.writeTo(new FileOutputStream(new File("src/input/SOSwapOfferAddResponse.xml")));
			soapConnection.close();

		    File xmlresponse = new File("src/input/SOSwapOfferAddResponse.xml");
			...
			if (childnodes.item(0).getNodeName().equals("S:Body")) {
				...
				LOGGER.log(Level.INFO, "RESULT SUCCESS : " + subscrNo );
