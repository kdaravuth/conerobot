...
public class OfferDisconnect {
	...
	public static void createSEOfferDisconnect(SOAPMessage soapMessage, String subscrNo, String  subscrNoReset, String OfferId)
	...
	// Create SOAP request
	private static SOAPMessage createSOAPRequestOfferDisconnect(String soapAction, String subscrNo, String  subscrNoReset, String OfferId)
			throws Exception {
		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();

		createSEOfferDisconnect(soapMessage, subscrNo,  subscrNoReset, OfferId);
	...
	public static void callingOfferDisconnect(String subscrNo, String  subscrNoReset, String OfferId)
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(createSOAPRequestOfferDisconnect(soapAction, subscrNo,  subscrNoReset, OfferId),
					soapEndpointUrl);
			...
			LOGGER.log(Level.SEVERE, "RESULT FAIL "+ e.getCause().toString());
		}
