 ...
 *
 */
public class SubscriberUpdateTargetAccount {
	...
	public static void createSESubTargetAccountUpdate(SOAPMessage soapMessage, String SubscrNo, String SubscrNoResets, String TargetAccountNo) throws SOAPException {
		...
		SOAPElement targetAccountNo = subscriber.addChildElement("targetAccountNo");
		...
		targetAccountNoValue.addTextNode(TargetAccountNo);
	...
	private static SOAPMessage createSOSubTargetAccountUpdate(String soapAction, String SubscrNo, String SubscrNoResets, String TargetAccountNo) throws Exception {

		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();

		createSESubTargetAccountUpdate(soapMessage, SubscrNo, SubscrNoResets, TargetAccountNo);
	...
	public static void callingSubTargetAccountUpdate(String SubscrNo, String SubscrNoResets, String TargetAccountNo) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection
					.call(createSOSubTargetAccountUpdate(soapAction, SubscrNo, SubscrNoResets, TargetAccountNo), soapEndpointUrl);
